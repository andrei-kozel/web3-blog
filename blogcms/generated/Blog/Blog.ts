...
export class Blog__fetchPostResultPostStruct extends ethereum.Tuple {
  get id(): BigInt {
...
export class Blog extends ethereum.SmartContract {
  ...
  fetchPost(_hash: string): Blog__fetchPostResultPostStruct {
    ...
    return changetype<Blog__fetchPostResultPostStruct>(result[0].toTuple());
  }

  try_fetchPost(
    _hash: string
  ): ethereum.CallResult<Blog__fetchPostResultPostStruct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<Blog__fetchPostResultPostStruct>(value[0].toTuple())
    );
  }
